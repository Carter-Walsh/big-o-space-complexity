    ...
    calcFac(num) {
        if (this.cache[num]) {
            ...
            for (let i = num; num > 0; i--) {
                let currentFac = num * i;
                answer += currentFac;
            }

            return this.cache[num] = answer; 
        }
    }
}
...
const myMemoization = new memoizationChallenge();

console.time("not memoized function time");
console.log(squaredNumbers(8))
console.log(squaredNumbers(8))
console.log(squaredNumbers(8))
console.log(squaredNumbers(8))
...
console.log(myMemoization.squareNumbers(8))
console.log(myMemoization.squareNumbers(8))
console.log(myMemoization.squareNumbers(8))
console.log(myMemoization.squareNumbers(8))
